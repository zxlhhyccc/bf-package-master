...
o:value("https://cdn.jsdelivr.net/gh/mattraks/domain-list-community@release/gfwlist.txt", translate("v2fly/domain-list-community"))
...
o.default = "https://cdn.jsdelivr.net/gh/mattraks/domain-list-community@release/gfwlist.txt"
