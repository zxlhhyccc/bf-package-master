...
if is_finded("pdnsd") then
	o:value("4", translate("Use Pdnsd tcp query and cache"))
end
if is_finded("mosdns") then
	o:value("5", translate("Use MosDNS query (Not Support Oversea Mode)"))
end
if is_finded("dnsproxy") then
	o:value("6", translate("Use DNSPROXY query and cache"))
end
if is_finded("chinadns-ng") then
	o:value("7", translate("Use ChinaDNS-NG query and cache"))
end
