...
return L.view.extend({
	...
	render:function(ver){
		...
		o=s.taboption('basic',form.Value,'BinaryLocation',_('Customized Location'),
		...
		o=s.taboption('webui',form.Value,'Address',_('Listening Address'),
			_('The listening IP address for WebUI.'));
		o.datatype='ipaddr';
		o.placeholder='0.0.0.0';

		o=s.taboption('webui',form.Value,'Port',_('Listening Port'),
