...
remote_dns.default = "tcp://156.154.70.1"
...
remote_dns:value("tcp://156.154.70.1", "156.154.70.1 (Neustar Ultra DNS )")
remote_dns:value("tcp://1.1.1.1", "1.1.1.1 (CloudFlare DNS TCP)")
remote_dns:value("tcp://198.153.194.1", "198.153.194.1 (Norton DNS)")
remote_dns:value("tcp://199.85.127.10", "199.85.127.10 (NortonConnectSafe DNS)")
...
remote_dns.default = "tcp://198.153.194.1"
remote_dns:value("tls://8.8.8.8", "8.8.8.8 (Google DNS)")
remote_dns:value("tls://8.8.4.4", "8.8.4.4 (Google DNS)")
remote_dns:value("tls://9.9.9.9", "9.9.9.9 (Quad9 DNS)")
remote_dns:value("tls://1.1.1.1", "1.1.1.1 (CloudFlare DNS)")
...
remote_dns:value("208.67.220.220", "208.67.220.220 (Open DNS)")
remote_dns:depends( "configfile", "./def_config.yaml")
remote_dns = s:option(Value, "remote_dns3", " ")
remote_dns.default = "tcp://199.85.127.10"
remote_dns:value("tls://8.8.8.8", "8.8.8.8 (Google DNS)")
remote_dns:value("tls://8.8.4.4", "8.8.4.4 (Google DNS)")
remote_dns:value("tls://9.9.9.9", "9.9.9.9 (Quad9 DNS)")
remote_dns:value("tls://1.1.1.1", "1.1.1.1 (CloudFlare DNS)")
