...
o = s:taboption("settings", Value, "address", translate("Listening address"))
o.description = translate("Use 0.0.0.0:2017 to monitor all access.")
o.datatype = "ipaddrport(1)"
o.default = "0.0.0.0:2017"
o.rmempty = false

o = s:taboption("settings", Value, "config", translate("Configuration"))
o.description = translate("Configuration directory.")
o.datatype = path
...
o = s:taboption("settings", ListValue, "log_max_days", translate("Max log retention period"))
