...
if running then
        state_msg = "<b><font style=\"color:green\">" .. translate("正在运行") .. "</font></b>"
else
        state_msg = "<b><font style=\"color:red\">" .. translate("没有运行") .. "</font></b>"
end
...
e.anonymous = true
t = e:option(Flag, "enable", translate("开启（<font style=\"color:green\">总开关</font>）") , translate(""))
t.rmempty = false
